...
/**
 * Interface JPA Repository para operações de banco de dados da entidade ArquivoComentario.
 */
@Repository
public interface ArquivoComentarioJpaRepository extends JpaRepository<ArquivoComentario, Long> {
